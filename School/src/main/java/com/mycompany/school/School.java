...
public class School {
    public static void main(String[] args) {
        // Δημιουργεί 5 μαθήματα
        Course[] courses = new Course[5];
        
        for (int i = 0; i < 5; i++) {
            courses[0] = new Course("M" , "Mathematics");
            courses[1] = new Course("E" , "Economics");
            courses[2] = new Course("C" , "Computer Science");
            courses[3] = new Course("S" , "Spanish");
            courses[4] = new Course("B" , "Biology");
        }
        ...
        // Αναθέτει μαθήματα, τάξεις και καθηγητές
        for (int i = 0; i < 5; i++) {
            teachers[i].setCourse(courses[i]);
            courses[i].setClassObj(classes[i]);
